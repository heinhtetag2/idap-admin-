      ...
      >
        ...
        <div className="relative flex items-start justify-between gap-4">
          <div>
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-white/10 rounded-full text-xs font-medium text-white backdrop-blur-sm">
              ...
              <button
                ...
                className={`relative text-left p-4 rounded-md border transition-colors cursor-pointer ${
                  isActive
                    ...
                    : 'border-[#E3E3E3] bg-white hover:border-[#FFDED5]'
                }`}
              >
                {pkg.badge && (
                  <span
                    className={`absolute -top-2 right-3 px-2 py-0.5 text-[10px] font-medium rounded-full ${
                      isActive
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-md border text-sm font-medium transition-colors cursor-pointer ${
                    isActive
                      ...
                      : 'border-[#E3E3E3] bg-white text-[#4A4A4A] hover:border-[#FFDED5] hover:bg-[#FAFAFA]'
                  }`}
                >
          ...
          <table className="w-full text-left text-sm whitespace-nowrap">
            <thead>
              <tr className="border-b border-[#E3E3E3] text-[#8A8A8A] font-medium bg-[#F7F7F7]">
                ...
                <th className="px-6 py-4 font-medium text-sm">{t('Description')}</th>
                <th className="px-6 py-4 font-medium text-sm">{t('Status')}</th>
                <th className="px-6 py-4 font-medium text-sm text-right">{t('Amount')}</th>
