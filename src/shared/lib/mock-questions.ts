  ...
  switch (category) {
    case 'Social':
      return [
        ...
        q('Rate your overall trust in social media content', 'rating'),
    ...
    case 'Product':
      return [
        ...
        q('Rate the overall quality of our product', 'rating'),
    ...
    case 'Brand':
      return [
        ...
        q('Rate your trust in our brand', 'rating'),
    ...
    case 'Market Research':
      return [
        ...
        q('Rate your overall satisfaction with existing options', 'rating'),
    ...
    default:
      return [
        q('Rate your overall satisfaction', 'rating'),
