  ...
  return (
    <>
      ...
      <div className={cn("flex-1 overflow-y-auto px-3 py-4 overflow-x-hidden", isCollapsed ? "space-y-3" : "space-y-6")}>
        ...
        <div>
          <div className={cn(
            "mb-2 text-[11px] font-medium text-[#8A8A8A] uppercase tracking-wider transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
        ...
        <div>
          ...
          <div className="space-y-0.5">
            <NavItem icon={ShieldAlert} label={t("Reports")} path="/reports" isCollapsed={isCollapsed} />
          </div>
        </div>
        ...
        <div className="relative group">
          <div className={cn(
            ...
            {!isCollapsed && (
              <div className="flex flex-col min-w-0 flex-1">
                ...
                <span className="text-xs text-[#FF3C21] truncate text-left">Super admin</span>
              </div>
            )}
          </div>
          ...
          <div className="absolute left-full bottom-0 ml-2 w-56 bg-white border border-[#E3E3E3] rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 p-1.5 flex flex-col gap-0.5">
            <div className="px-2.5 py-2 mb-1">
              ...
              <span className="block text-xs text-[#8A8A8A] truncate">heincise@gmail.com</span>
            </div>
